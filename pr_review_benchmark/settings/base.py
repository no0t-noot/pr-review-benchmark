...
INSTALLED_APPS = [
    # Project apps
    "pr_review_benchmark.auth",
    "pr_review_benchmark.core",
    "pr_review_benchmark.registration",
    "pr_review_benchmark.users",
    "pr_review_benchmark.products",
    # Django core apps
...
ROOT_URLCONF = "pr_review_benchmark.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [os.path.join(BASE_DIR, "pr_review_benchmark", "templates")],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
                ...
                "pr_review_benchmark.core.context_processors.common",
            ],
        },
    },
]
...
WSGI_APPLICATION = "pr_review_benchmark.wsgi.application"
...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "pr_review_benchmark@localhost")
...
LOCALE_PATHS = [os.path.join(BASE_DIR, "pr_review_benchmark", "locale")]
...
STATICFILES_DIRS = [
    ...
    # `pr_review_benchmark/static`
    os.path.join(BASE_DIR, "pr_review_benchmark", "static"),
    # Static files that are built by external tooling, e.g. Tailwind
    # are stored in `pr_review_benchmark/static_built`
    os.path.join(BASE_DIR, "pr_review_benchmark", "static_built"),
]
...
# Serve the contents of pr_review_benchmark/static/meta at the root path
WHITENOISE_ROOT = os.path.join(BASE_DIR, "pr_review_benchmark", "static", "meta")
...
SPECTACULAR_SETTINGS = {
    "TITLE": "pr_review_benchmark",
    "DESCRIPTION": "API documentation for the pr_review_benchmark project",
    "VERSION": "0.0.0",
...
CELERY_BEAT_SCHEDULE = {
    "hello_world_every_10_minutes": {
        "task": "pr_review_benchmark.core.tasks.hello_world",
