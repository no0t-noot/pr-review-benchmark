...
urlpatterns = [
    ...
    path("products/<int:product_id>/purchase/", api_views.PurchaseAPIView.as_view(), name="product-purchase"),
    path("products/transfer-stock/", api_views.StockTransferAPIView.as_view(), name="stock-transfer"),
]
